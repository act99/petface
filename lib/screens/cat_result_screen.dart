...
class CatResultScreen extends StatefulWidget {
  final bool gender;
  ...
  @override
  _CatResultScreenState createState() => _CatResultScreenState();
}

class _CatResultScreenState extends State<CatResultScreen> {
  @override
  void initState() {
    super.initState();
  }
