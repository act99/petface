...
class DogPhotoScreen extends StatefulWidget {
  @override
  _DogPhotoScreenState createState() => _DogPhotoScreenState();
}

class _DogPhotoScreenState extends State<DogPhotoScreen> {
  _launchURL() async {
                ...
                child: RaisedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => DogChooseGenderScreen(),
                      ),
                    );
                  },
                  ...
                  child: Ink(
                    decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [Color(0xfff6d5ad), Color(0xfff0d9bc)],
