...
import 'package:petface/screens/cat_loading_screen.dart';
import 'package:petface/tflite/photo_helper.dart';
import 'package:tflite/tflite.dart';

class CatChooseSpeciesScreen extends StatefulWidget {
  final bool gender;
  CatChooseSpeciesScreen({this.gender});

  @override
  _CatChooseSpeciesScreenState createState() => _CatChooseSpeciesScreenState();
}

class _CatChooseSpeciesScreenState extends State<CatChooseSpeciesScreen> {
  ...
  void initState() {
    super.initState();
    TFLiteHelper.loadModelCat().then((value) {
      setState(() {
...
class CatChooseScreen extends StatefulWidget {
  ...
  CatChooseScreen({this.gender, this.imageFile1});
  @override
  _CatChooseScreenState createState() => _CatChooseScreenState();
}
