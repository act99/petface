...
import 'package:petface/screens/dog_choose_screen.dart';
import 'package:petface/widget/rolling_switch.dart';

class DogChooseGenderScreen extends StatefulWidget {
  @override
  _DogChooseGenderScreenState createState() => _DogChooseGenderScreenState();
}

class _DogChooseGenderScreenState extends State<DogChooseGenderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        foregroundColor: Color(0xfff0d9bc),
        shadowColor: Color(0xfff0d9bc),
        elevation: 0.0,
      ),
      body: SafeArea(
        child: Center(
                    ...
                    child: FlatButton(
                      onPressed: () {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => DogChooseSpeciesScreen(
                                      gender: gender,
                                    )));
                      },
                      child: Text(
